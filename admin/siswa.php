...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="siswa_tambah.php" class="btn btn-success">➕ Tambah Siswa</a>
    </div>
    ...
    <?php if (isset($_GET['pesan'])): ?>
        ...
        $pesan = $_GET['pesan'];
        $text = "";
        if ($pesan == 'tambah') $text = "✅ Data siswa berhasil ditambahkan!";
        elseif ($pesan == 'edit') $text = "✏️ Data siswa berhasil diperbarui!";
        elseif ($pesan == 'hapus') $text = "🗑️ Data siswa berhasil dihapus!";
        ?>
