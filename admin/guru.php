...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="guru_tambah.php" class="btn btn-success">
            ➕ Tambah Guru
        </a>
    </div>
    ...
    <?php if (isset($_GET['pesan'])): ?>
        ...
        $pesan = $_GET['pesan'];
        $text = "";
        if ($pesan == 'tambah') $text = "✅ Data guru berhasil ditambahkan!";
        elseif ($pesan == 'edit') $text = "✏️ Data guru berhasil diperbarui!";
        elseif ($pesan == 'hapus') $text = "🗑️ Data guru berhasil dihapus!";
        ?>
